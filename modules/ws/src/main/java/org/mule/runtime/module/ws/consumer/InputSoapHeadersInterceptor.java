      ...
      if (outboundProperty.startsWith(WSConsumer.SOAP_HEADERS_PROPERTY_PREFIX)) {
        ...
        try {
          ...
          throw new Fault(new TransformerMessagingException(
                                                            CoreMessages
                                                                .createStaticMessage("Cannot find transformer to convert outbound property %s to XML",
                                                                                     outboundProperty),
        ...
        try {
          ...
          throw new Fault(new TransformerMessagingException(
                                                            CoreMessages
                                                                .createStaticMessage("Outbound property %s contains an invalid XML string",
                                                                                     outboundProperty),
                                                            event, transformer, e.getCause()));
        }
      }
