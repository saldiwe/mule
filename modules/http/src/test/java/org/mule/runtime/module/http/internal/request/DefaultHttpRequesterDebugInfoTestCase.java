...
public class DefaultHttpRequesterDebugInfoTestCase extends AbstractMuleContextTestCase
{
    ...
    public void setup() throws Exception
    {
        ...
        event = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), message, MessageExchangePattern.REQUEST_RESPONSE, getTestFlow());
    }
