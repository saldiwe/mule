  ...
  private class FactoryDelegate {
    ...
    private RuntimeExtensionModel toExtension(ExtensionDeclaration extensionDeclaration) {
      ...
      RuntimeExtensionModel extensionModel = new ImmutableRuntimeExtensionModel(extensionDeclaration.getName(),
                                                                                ...
                                                                                sortConfigurations(toConfigurations(extensionDeclaration
                                                                                    .getConfigurations(), extensionModelValueHolder)),
                                                                                toOperations(extensionDeclaration
                                                                                    .getOperations()),
                                                                                toConnectionProviders(extensionDeclaration
                                                                                    .getConnectionProviders()),
                                                                                toMessageSources(extensionDeclaration
                                                                                    .getMessageSources()),
    ...
    private ConfigurationModel toConfiguration(ConfigurationDeclaration declaration,
      ...
      return fromCache(declaration, () -> new ImmutableRuntimeConfigurationModel(declaration.getName(),
                                                                                 declaration.getDescription(),
                                                                                 extensionModel::get,
                                                                                 declaration.getConfigurationFactory(),
                                                                                 toParameters(declaration.getParameters()),
                                                                                 toOperations(declaration.getOperations()),
                                                                                 toConnectionProviders(declaration
                                                                                     .getConnectionProviders()),
                                                                                 toMessageSources(declaration
                                                                                     .getMessageSources()),
    ...
    private RuntimeSourceModel toMessageSource(SourceDeclaration declaration) {
      return fromCache(declaration, () -> new ImmutableRuntimeSourceModel(declaration.getName(),
                                                                          declaration.getDescription(),
                                                                          toParameters(declaration.getParameters()),
    ...
    private RuntimeConnectionProviderModel toConnectionProvider(ConnectionProviderDeclaration declaration) {
      return fromCache(declaration, () -> new ImmutableRuntimeConnectionProviderModel(
                                                                                      declaration.getName(),
                                                                                      declaration.getDescription(),
