...
public class MuleExtensionUtils
{
    ...
    {
        return new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), MuleMessage.builder().nullPayload().build(), REQUEST_RESPONSE, new FlowConstruct()
        {
