    ...
    baseDeclaration
        ...
        .ifPresent(
                   implementingType -> {
                     ...
                     final List<FieldElement> parameterGroups = new ParameterizableTypeWrapper(type)
                         .getAnnotatedFields(org.mule.runtime.extension.api.annotation.ParameterGroup.class);
