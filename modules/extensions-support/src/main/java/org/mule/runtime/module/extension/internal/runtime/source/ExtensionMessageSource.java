        ...
        ExceptionCallback<Void, Throwable>
{
    ...
    {
        MuleEvent event =
                new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), (org.mule.runtime.core.api.MuleMessage) message, REQUEST_RESPONSE, flowConstruct);
