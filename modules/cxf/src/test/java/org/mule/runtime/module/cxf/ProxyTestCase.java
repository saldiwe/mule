...
public class ProxyTestCase extends FunctionalTestCase {
  ...
  public void testOneWayDispatchWithSoapActionSpoofing() throws Exception {
    ...
    client.dispatch("http://localhost:" + dynamicPort.getNumber() + "/services/onewayWithSoapAction", MuleMessage
        .builder().payload(prepareOneWayTestMessage()).outboundProperties(prepareOneWaySpoofingTestProperties()).build(),
                    HTTP_REQUEST_OPTIONS);
  ...
  public void testOneWaySend() throws Exception {
    ...
    MuleMessage result = client.send("http://localhost:" + dynamicPort.getNumber() + "/services/oneway",
                                     MuleMessage.builder().payload(prepareOneWayTestMessage())
                                         .outboundProperties(prepareOneWayTestProperties()).build(),
                                     HTTP_REQUEST_OPTIONS);
    assertNotNull(result);
  ...
  public void testOneWayDispatch() throws Exception {
    ...
    client.dispatch("http://localhost:" + dynamicPort.getNumber() + "/services/oneway",
                    MuleMessage.builder().payload(prepareOneWayTestMessage()).outboundProperties(prepareOneWayTestProperties())
                        .build(),
                    HTTP_REQUEST_OPTIONS);
