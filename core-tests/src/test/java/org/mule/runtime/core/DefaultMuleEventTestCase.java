...
public class DefaultMuleEventTestCase extends AbstractMuleContextTestCase
{
    ...
    {
        muleEvent = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), muleMessage, REQUEST_RESPONSE, getTestFlow());
    }
    ...
    public void defaultProcessingStrategyRequestResponse() throws Exception
    {
        ...
        DefaultMuleEvent event = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), muleMessage, REQUEST_RESPONSE, flow);
    ...
    public void defaultProcessingStrategyOneWay() throws Exception
    {
        ...
        when(flow.getProcessingStrategy()).thenReturn(new DefaultFlowProcessingStrategy());
        when(flow.getMuleContext()).thenReturn(muleContext);
        DefaultMuleEvent event = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), muleMessage, ONE_WAY, flow);
