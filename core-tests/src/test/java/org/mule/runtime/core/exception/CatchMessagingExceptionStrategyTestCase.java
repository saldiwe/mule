...
public class CatchMessagingExceptionStrategyTestCase extends AbstractMuleContextTestCase
{
    ...
    public void before() throws Exception
    {
        ...
        mockMuleEvent = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), muleMessage, getTestFlow());
    }
    ...
    {
        MuleEvent lastEventCreated = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), muleMessage, getTestFlow());
        catchMessagingExceptionStrategy.setMessageProcessors(
                asList(createChagingEventMessageProcessor(new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), muleMessage, getTestFlow())),
    ...
    public void testMessageToStringNotCalledOnFailure() throws Exception
    {
        ...
        MuleEvent lastEventCreated = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), muleMessage, getTestFlow());
        catchMessagingExceptionStrategy.setMessageProcessors(
                asList(createFailingEventMessageProcessor(new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), muleMessage, getTestFlow())),
    ...
    private MuleEvent createNonBlockingTestEvent() throws Exception
    {
        ...
        return new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), MuleMessage.builder().payload(TEST_MESSAGE).build(), REQUEST_RESPONSE,
