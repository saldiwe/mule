...
public class QueuePersistenceObjectStoreTestCase extends AbstractObjectStoreContractTestCase
{
    ...
    public void testMonitoredWrapper() throws Exception
    {
        ...
        MuleEvent event = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), msg, MessageExchangePattern.ONE_WAY, getTestFlow());
