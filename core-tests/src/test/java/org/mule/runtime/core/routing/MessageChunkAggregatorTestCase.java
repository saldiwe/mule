...
public class MessageChunkAggregatorTestCase extends AbstractMuleContextTestCase
{
    ...
    public void testMessageProcessor() throws Exception
    {
        ...
        DefaultMuleEvent event1 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), message1.getUniqueId()), message1, getTestFlow(), session);
        event1.setCorrelation(new Correlation(message1.getUniqueId(), 3, null));
        MuleEvent event2 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), message1.getUniqueId()), message2, getTestFlow(), session);
        MuleEvent event3 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), message1.getUniqueId()), message3, getTestFlow(), session);
