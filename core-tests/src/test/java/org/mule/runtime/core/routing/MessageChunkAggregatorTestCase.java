...
public class MessageChunkAggregatorTestCase extends AbstractMuleContextTestCase
{
    ...
    public void testMessageProcessor() throws Exception
    {
        ...
        MuleEvent event1 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), message1, getTestFlow(), session);
        MuleEvent event2 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), message2, getTestFlow(), session);
        MuleEvent event3 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), message3, getTestFlow(), session);
