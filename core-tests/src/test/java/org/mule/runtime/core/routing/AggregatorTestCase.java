...
public class AggregatorTestCase extends AbstractMuleContextTestCase
{
    ...
    public void testMessageAggregator() throws Exception
    {
        ...
        MuleEvent event1 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), message1.getUniqueId()), message1, flow, session);
        MuleEvent event2 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), message1.getUniqueId()), message2, flow, session);
        MuleEvent event3 = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), message1.getUniqueId()), message3, flow, session);
