...
public class ParserComponentBuildingDefinitionProvider implements ComponentBuildingDefinitionProvider {
  ...
  public List<ComponentBuildingDefinition> getComponentBuildingDefinitions() {
    ...
    ComponentBuildingDefinition.Builder baseParameterCollectionParserBuilder = baseBuilder
        ...
        .withSetterParameterDefinition("simpleTypeListWithConverter", fromChildConfiguration(List.class)
        ...
        .withSetterParameterDefinition("simpleTypeMap", fromChildMapConfiguration(String.class, Integer.class)
            .withWrapperIdentifier("simple-type-map").build())
        .withSetterParameterDefinition("simpleListTypeMap", fromChildMapConfiguration(String.class, String.class)
            .withWrapperIdentifier("simple-list-type-map").build())
        .withSetterParameterDefinition("complexTypeMap", fromChildMapConfiguration(Long.class, SimpleCollectionObject.class)
            .withWrapperIdentifier("complex-type-map").build())
        .withSetterParameterDefinition("simpleParameters", fromMultipleDefinitions(
                                                                                   newBuilder()
                                                                                       .withAttributeDefinition(fromSimpleParameter("firstname")
                                                                                           .build())
                                                                                       .withKey("firstname")
                                                                                       .build(),
                                                                                   newBuilder()
    ...
    definitions.add(baseBuilder
        ...
        .withSetterParameterDefinition("simplePojo", fromSimpleParameter("myPojo", input -> new SimplePojo((String) input))
    ...
    definitions.add(baseBuilder
        ...
        .withSetterParameterDefinition("elementTypeA", fromChildConfiguration(SimpleCollectionObject.class)
            .withIdentifier("elementTypeA").build())
