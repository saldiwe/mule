...
public class TestClusterizableMessageSource implements ClusterizableMessageSource, Startable, MuleContextAware, FlowConstructAware
{
    ...
    public void start() throws MuleException
    {
        ...
        DefaultMuleEvent defaultMuleEvent = new DefaultMuleEvent(new DefaultMessageExecutionContext(context.getUniqueIdString(), null), muleMessage, MessageExchangePattern.ONE_WAY, flowConstruct);
