...
public class TestEventBuilder {
  ...
  public MuleEvent build(MuleContext muleContext, FlowConstruct flow) {
    ...
    DefaultMuleEvent event = new DefaultMuleEvent(
                                                  (MuleMessage) spyTransformer.transform(muleMessage), URI.create("none"), "none",
                                                  exchangePattern, flow, new DefaultMuleSession(),
                                                  muleContext.getConfiguration().getDefaultResponseTimeout(), null, null,
