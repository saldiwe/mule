...
public class MuleEventCopyPerformanceTestCase extends AbstractMuleContextTestCase
{
    ...
    {
        return new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), MuleMessage.builder().payload(payload).build(), ONE_WAY, flow);
    }
