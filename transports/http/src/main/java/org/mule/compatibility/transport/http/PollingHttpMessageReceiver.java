...
public class PollingHttpMessageReceiver extends AbstractPollingMessageReceiver
{
    ...
    public void poll() throws Exception
    {
        ...
        MuleEvent event = new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), requestBuider.build(), outboundEndpoint.getExchangePattern(), flowConstruct);
