...
public class HttpRequestBodyToParamMapTestCase extends AbstractMuleContextTestCase
{
    ...
    public void validGet() throws Exception
    {
        ...
        verifyTransformation(transform(new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), msg, getTestFlow())));
    }
    ...
    public void invalidContentType() throws Exception
    {
        ...
        transform(new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), msg, getTestFlow()));
    }
