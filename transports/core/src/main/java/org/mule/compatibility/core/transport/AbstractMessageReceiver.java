...
public abstract class AbstractMessageReceiver extends AbstractTransportMessageHandler implements MessageReceiver
{
        ...
        throws MuleException
    {
        ...
        {
            newEvent = new DefaultMuleEvent(new DefaultMessageExecutionContext(flowConstruct.getMuleContext().getUniqueIdString(), null), message, flowConstruct, session, replyToHandler,
                    replyToFromMessage, ros);
        }
        else
        {
            newEvent = new DefaultMuleEvent(new DefaultMessageExecutionContext(flowConstruct.getMuleContext().getUniqueIdString(), null), message, flowConstruct, session, null, null, ros);
        }
