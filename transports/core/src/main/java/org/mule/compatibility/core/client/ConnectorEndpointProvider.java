    ...
    protected MessageProcessor buildMessageProcessor(RequestCacheKey cacheKey) throws MuleException
    {
        ...
        else
        {
            ...
            return event ->
            {
                ...
                return message != null ? new DefaultMuleEvent(new DefaultMessageExecutionContext(muleContext.getUniqueIdString(), null), message, new MuleClientFlowConstruct(muleContext)) : null;
            };
        }
    }
