...
public class FileMessageReceiver extends AbstractPollingMessageReceiver
{
    ...
    public void processFile(File file) throws MuleException
    {
        ...
        final DefaultMuleEvent event = new DefaultMuleEvent(new DefaultMessageExecutionContext(flowConstruct.getMuleContext().getUniqueIdString(), null), fileParserMessasge, flowConstruct);
