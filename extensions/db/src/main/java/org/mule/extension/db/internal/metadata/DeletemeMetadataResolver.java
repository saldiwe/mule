...
public class DeletemeMetadataResolver implements MetadataOutputResolver
{
    ...
    {
        DictionaryTypeBuilder typeBuilder = new BaseTypeBuilder<>(JAVA).dictionaryType();
        typeBuilder.ofKey().stringType();
        typeBuilder.ofValue().anyType();
