...
public interface StatementFactory {
   ...
   */
  Statement create(DbConnection connection, Query query) throws SQLException;
   ...
   * @throws SQLException if a database access error occurs or this method is called on a closed connection
   */
  Statement create(DbConnection connection, Query query, AutoGeneratedKeyStrategy autoGeneratedKeyStrategy) throws SQLException;
}
