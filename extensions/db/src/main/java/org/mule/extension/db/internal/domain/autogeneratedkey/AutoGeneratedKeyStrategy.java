...
public interface AutoGeneratedKeyStrategy
{
     ...
     * @param query      query template to be prepared
     * @return a statement prepared to return auto generated keys
     * @throws SQLException if there is any error preparing the query
     */
    PreparedStatement prepareStatement(DbConnection connection, Query query) throws SQLException;
     ...
     */
    boolean execute(Statement statement, Query query) throws SQLException;
     ...
     * @throws SQLException if there is any database error or this method is called on a closed Statement
     */
    int executeUpdate(Statement statement, Query query) throws SQLException;
}
