...
/**
 * Resolves {@link Query} actual {@link DbType types} for a given {@link DbConnection}
 */
public interface ParamTypeResolver {
   ...
   * @param query query containing UNKNOWN parameter types
   ...
   */
  Map<Integer, DbType> getParameterTypes(DbConnection connection, Query query) throws SQLException;
}
