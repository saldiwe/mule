...
public interface StatementResultHandler
{
     ...
     * @param query executed query. Non null
     ...
     */
    Object processStatement(DbConnection connection, Statement statement, Query query, AutoGeneratedKeyStrategy autoGeneratedKeyStrategy) throws SQLException;
}
