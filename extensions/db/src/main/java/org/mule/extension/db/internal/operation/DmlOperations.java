...
public class DmlOperations
{
     ...
     *                  collection and a bulk update executes for each item in the collection.
     */
    public int update(Statement statement, @Optional(defaultValue = "false") boolean bulkMode, @ParameterGroup QuerySettings settings)
    {
        return 0;
    }
     ...
     *                  collection and a bulk update executes for each item in the collection.
     */
    public int delete(Statement statement, @Optional(defaultValue = "false") boolean bulkMode, @ParameterGroup QuerySettings settings)
    {
        return 0;
    }
     ...
     * @return
     */
    public Map<String, Object> storedProcedure(CallableStatement statement,
                                               @Optional(defaultValue = "false") boolean streaming,
                                               @Optional(defaultValue = "10") int fetchSize,
                                               @Optional Integer maxRows,
                                               @ParameterGroup AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
