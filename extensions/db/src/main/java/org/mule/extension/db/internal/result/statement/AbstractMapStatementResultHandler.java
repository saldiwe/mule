...
public abstract class AbstractMapStatementResultHandler implements StatementResultHandler {
  ...
  @Override
  public Map<String, Object> processStatement(DbConnection connection, Statement statement, Query query,
    ...
    StatementResultIterator statementResultIterator =
        statementResultIteratorFactory.create(connection, statement, query, autoGeneratedKeyStrategy);
