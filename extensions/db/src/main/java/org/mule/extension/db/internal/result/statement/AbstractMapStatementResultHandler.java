...
public abstract class AbstractMapStatementResultHandler implements StatementResultHandler
{
    ...
    @Override
    public Map<String, Object> processStatement(DbConnection connection, Statement statement, Query query, AutoGeneratedKeyStrategy autoGeneratedKeyStrategy) throws SQLException
    {
        ...
        StatementResultIterator statementResultIterator = statementResultIteratorFactory.create(connection, statement, query, autoGeneratedKeyStrategy);
