...
public abstract class AbstractSingleQueryExecutor extends AbstractExecutor implements QueryExecutor
{
    ...
    {
        Statement statement = statementFactory.create(connection, query);
    ...
    {
        Statement statement = statementFactory.create(connection, query, autoGeneratedKeyStrategy);
    ...
    {
        SingleQueryLogger queryLogger = queryLoggerFactory.createQueryLogger(LOGGER, query);

        if (statement instanceof PreparedStatement)
        {
            doProcessParameters((PreparedStatement) statement, query, queryLogger);
        }
