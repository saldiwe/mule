...
import static org.mule.runtime.core.config.i18n.CoreMessages.commitTxButNoResource;
import static org.mule.runtime.core.config.i18n.CoreMessages.rollbackTxButNoResource;
import org.mule.extension.db.internal.i18n.DbMessages;
...
public class DbTransaction extends AbstractSingleResourceTransaction
{
    ...
    protected void doCommit() throws TransactionException
    {
        if (resource == null)
        {
            logger.warn(commitTxButNoResource(this).getMessage());
            return;
        }
    ...
    protected void doRollback() throws TransactionException
    {
        if (resource == null)
        {
            logger.warn(rollbackTxButNoResource(this).getMessage());
            return;
        }
